...
[assembly: HostingStartup(typeof(LowVision.Areas.Identity.IdentityHostingStartup))]
namespace LowVision.Areas.Identity
{
    public class IdentityHostingStartup : IHostingStartup
    {
        public void Configure(IWebHostBuilder builder)
        {
            builder.ConfigureServices((context, services) => {
                services.AddDbContext<LowVisionDBContext>(options =>
